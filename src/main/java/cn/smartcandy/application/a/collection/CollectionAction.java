...
public class CollectionAction extends BaseAction{
	...
	public String addCollection()  throws Exception {
		...
		collectionBiz.addCollection(param, cateArr, tagArr, super.getAdmin());
		return null;
	}
	// 修改藏品
	public String modifyCollection()  throws Exception {
	    ...
	    String[] cateArr = request.getParameterValues("cateSequence"); 
	    String[] tagArr = request.getParameterValues("searchTag"); 
		collectionBiz.modifyCollection(param,cateArr,tagArr,request,super.getAdmin());
		return null;
	}
	// 修改藏品在主页展示
	public String deleteCollectionShowInHome()  throws Exception {
        Map<String, String> param = TStringUtils.getStringMapFromRequest();
	    TStringUtils.printStringMap(param);
		collectionBiz.updateCollectionShowInHome(param,super.getAdmin());
		return null;
	}
	// 修改藏品
	public String deleteCollection()  throws Exception {
		...
		collectionBiz.deleteCollection(param,colList,request,super.getAdmin());
		return null;
	}
	...
	// 查询藏品（分页）（OK）
	public String queryHotCollectionDataList()  throws Exception {
        Map<String, String> param = TStringUtils.getStringMapFromRequest();
        DataTable dataTable = collectionBiz.queryHotCollectionDataList(param, super.getPageNo(), super.getPageSize());
	...
	//---------------------------------------藏品乱序------------------------------------------//
	public String reSortCollection()  throws Exception {
        Map<String, String> param = TStringUtils.getStringMapFromRequest();
        collectionBiz.updateCollectionSort(param, super.getAdmin());
		return null;
	}
